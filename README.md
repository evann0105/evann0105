...
<!-- CSS Grid with adjusted layout for side-by-side alignment -->
<div style="display: grid; grid-template-columns: 1fr auto; align-items: start; justify-content: center; gap: 20px; max-width: 600px; margin: auto;">
